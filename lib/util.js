 ...
 * Format middleware to match express infrastructure.
 */
function hookify(handler, key) {
  var _this2 = this;

  var preHooks = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : new Map();
  var postHooks = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : new Map();
