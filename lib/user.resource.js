        ...
        handler: function () {
          var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref2) {
            var model = _ref2.model,
                ...
                email = _ref2$body.email,
                password = _ref2$body.password;

            var user, error, match, _error;
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 2:
                    ...
                    error = new Error('No user was found for the given email.');
                  ...
                  case 9:
                    ...
                    _error = new Error('Password is incorrect.');
